  ...
  _createClass(Bootcamp, null, [{
    ...
    value: function () {
      var _addSiswa = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(input) {
        var _input$split5, _input$split6, studentName, trainerName;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _input$split5 = input.split(","), _input$split6 = _slicedToArray(_input$split5, 2), studentName = _input$split6[0], trainerName = _input$split6[1];
                try {
                  _promises["default"].readFile(path).then(function (data) {
